...
// Only implement methods that are NOT inline in Logger.h or inherited from
// Print
...
TEST_CASE(test_setup) {
  ...
  // Pinout::TRACK_LEFT_3V3 is defined in nimrs-pinout.h included by
  // DccController.h
